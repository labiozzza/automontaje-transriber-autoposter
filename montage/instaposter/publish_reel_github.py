...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Залить локальный Reel в public GitHub Raw "
            "и опубликовать его через Instagram API."
        )
    )
    ...
    parser.add_argument(
        "--no-feed",
        action="store_true",
        help="Не добавлять Reel в основную ленту профиля.",
    )
...
def main() -> None:
    ...
    print("\n5. Создаём Instagram REELS container...")
